...
export const products1 = [
  ...
  },
  {
    ...
    name: 'Total Loss Car',
    description:
      'A heavily damaged vehicle that is no longer roadworthy, typically with extensive mechanical or structural issues, rendering it beyond repair or restoration. Often sold for scrap or parts recovery.',
    price: 650,
    image: [p_img2_1, p_img2_2, p_img2_3, p_img2_4],
    category: 'Scrap Metal',
    subCategory: 'Non-Reuseable',
    sizes: ['F', 'H', 'R'],
    date: 1716621345448,
    bestseller: true,
  },
  {
      ...
      _id: "aaaac",
      name: "Landline box",
      description:'Durable scrap landline box available for recycling. Perfect for scrap dealers and businesses seeking to repurpose electronic components. Help promote sustainability by reducing waste and reusing valuable materials',
      price: 10,
      image: [p_img3],
      category: "Scrap Metal",
      subCategory: "Non-Reuseable",
  ...
  {
    _id: 'aaaad',
    name: 'Fishing Boat (2004)',
    description:
     ' A damaged or decommissioned fishing boat, typically made of metal or fiberglass, no longer seaworthy. Often used for scrap or parts recovery, this boat may have wear from years of use, including structural issues or engine failure, but still holds value for recycling and repurposing materials.',
    price: 300,
    image: [p_img4],
    category: 'Wooden Scraps',
    subCategory: 'Non Reuseable',
    sizes: ['F', 'H', 'R'],
    date: 1716621345448,
    bestseller: true,
  },
  {
    ...
    name: 'Television',
    description:
      'An outdated television set, often bulky and no longer functional, with a worn screen and outdated technology. Typically replaced by newer models, it is now suitable for recycling or repurposing, offering valuable components for reuse.',
    price: 80,
    image: [p_img5],
    category: 'Electronic',
    subCategory: 'non reuseable',
  ...
  },
  {
    ...
    name: 'Rubber Tyre',
    description:
      'A worn and damaged rubber tire, no longer suitable for use on vehicles. Often showing signs of severe wear or punctures, it is now intended for recycling or repurposing, offering valuable material for various industrial applications',
    price: 5,
    image: [p_img6],
    category: 'Others',
    subCategory: 'Non Reuseable',
  ...
  },
  {
    ...
    name: 'Wooden Window',
    description:
    'A sturdy, reusable wooden window with a durable frame and glass panes, ideal for repurposing in construction, renovation, or creative upcycling projects. Offers a classic look with the potential for restoration or reuse',
    price: 190,
    image: [p_img7],
    category: 'Wooden Scraps',
    subCategory: 'Reuseable',
  ...
  },
  {
    ...
    name: 'Compressor',
    description:
      'A non-functional compressor, no longer suitable for operation, but containing valuable metal and components for recycling or salvage. Ideal for scrap dealers and industries looking to repurpose materials and reduce waste',
    price: 22,
    image: [p_img9],
    category: 'Electronic',
    subCategory: 'Non Reuseable',
  ...
  },
  {
    ...
    description:'A non-functional washing machine, no longer operational but containing valuable metal, plastic, and electronic components for recycling or salvage. Ideal for scrap dealers and recycling facilities looking to repurpose materials and reduce waste.',
    price: 35,
    image: [p_img10],
    category: 'Electronic',
    subCategory: 'Non reuseable',
